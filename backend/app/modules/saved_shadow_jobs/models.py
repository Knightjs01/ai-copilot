...
class SavedShadowJob(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    __tablename__ = "saved_shadow_jobs"
    __table_args__ = (
        UniqueConstraint("candidate_user_id", "shadow_job_id", name="uq_saved_job_candidate_job"),
    )
