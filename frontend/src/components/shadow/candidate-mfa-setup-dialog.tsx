...
import { useCandidateMfaEnable, useCandidateMfaSetup } from "@/lib/queries/candidate-security";
...
// Mirrors components/security/mfa-setup-dialog.tsx (the company equivalent) exactly, swapped to
// candidate auth and /candidate-auth/mfa/*.
export function CandidateMfaSetupDialog({
  open,
  onOpenChange,
}: {
  open: boolean;
  ...
  const setup = useCandidateMfaSetup();
