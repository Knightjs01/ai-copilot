...
export function BrowserFrame({
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-2xl border border-border bg-white shadow-xl shadow-slate-900/[0.08]">
      {badge && (
      ...
      <div className="flex items-center gap-1.5 border-b border-border bg-slate-50 px-4 py-2.5">
        ...
        <div className="mx-auto flex items-center gap-1.5 rounded-full bg-white px-3 py-1 text-xs text-muted-foreground">
