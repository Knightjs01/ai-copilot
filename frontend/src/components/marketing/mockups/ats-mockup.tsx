        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="font-mono text-[11px] text-muted-foreground">project_id · vp-eng-04</p>
            </div>
            ...
            {COLUMNS.map((column) => (
              <div key={column.title} className="flex flex-col gap-2">
                ...
                {column.candidates.map((candidate) => (
                  ...
                  >
                    <p className="font-mono text-xs font-medium text-foreground">{candidate.callsign}</p>
                    <p className="font-mono text-[10px] text-muted-foreground">{candidate.ref}</p>
                    {candidate.tag && (
