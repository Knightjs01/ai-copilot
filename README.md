...
See [DEPLOYMENT.md](DEPLOYMENT.md) for the full Railway walkthrough (Postgres, Redis, real
email via Brevo, and inviting a second user into the same company's workspace).
